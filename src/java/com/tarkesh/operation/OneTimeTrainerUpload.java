 ...
 * @author tarkeshwar
 */
@WebServlet(name = "OneTimeTrainerUpload", urlPatterns = {"/OneTimeTrainerUpload"})
public class OneTimeTrainerUpload extends HttpServlet {
...
//trainer.setSkillset("BPM A and F");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet OneTimeTrainerUpload</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet OneTimeTrainerUpload at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
